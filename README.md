...
- [ViCrit: A Verifiable Reinforcement Learning Proxy Task for Visual Perception in VLMs](https://arxiv.org/abs/NeurIPS.2025)
...
- [Does Reinforcement Learning Really Incentivize Reasoning Capacity in LLMs Beyond the Base Model?](https://arxiv.org/abs/NeurIPS.2025)
...
- [Absolute Zero: Reinforced Self-play Reasoning with Zero Data](https://arxiv.org/abs/NeurIPS.2025)
...
- [CURE: Co-Evolving Coders and Unit Testers via Reinforcement Learning](https://arxiv.org/abs/NeurIPS.2025)
...
- [Enigmata: Scaling Logical Reasoning in Large Language Models with Synthetic Verifiable Puzzles](https://arxiv.org/abs/NeurIPS.2025)
...
- [To Think or Not To Think: A Study of Thinking in Rule-Based Visual Reinforcement Fine-Tuning](https://arxiv.org/abs/NeurIPS.2025)
...
- [Trust, But Verify: A Self-Verification Approach to Reinforcement Learning with Verifiable Rewards](https://arxiv.org/abs/NeurIPS.2025)
...
- [Beyond Verifiable Rewards: Scaling Reinforcement Learning in Language Models to Unverifiable Data](https://arxiv.org/abs/NeurIPS.2025)
...
- [RLVR-World: Training World Models with Reinforcement Learning](https://arxiv.org/abs/NeurIPS.2025)
...
- [SeRL: Self-play Reinforcement Learning for Large Language Models with Limited Data](https://arxiv.org/abs/NeurIPS.2025)
...
- [Learning to Reason under Off-Policy Guidance](https://arxiv.org/abs/NeurIPS.2025)
...
- [SWE-RL: Advancing LLM Reasoning via Reinforcement Learning on Open Software Evolution](https://arxiv.org/abs/NeurIPS.2025)
...
- [rStar-Coder: Scaling Competitive Code Reasoning with a Large-Scale Verified Dataset](https://arxiv.org/abs/NeurIPS.2025)
...
- [SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond](https://arxiv.org/abs/NeurIPS.2025)
...
- [SwS: Self-aware Weakness-driven Problem Synthesis in Reinforcement Learning for LLM Reasoning](https://arxiv.org/abs/NeurIPS.2025)
...
- [AceReason-Nemotron: Advancing Math and Code Reasoning through Reinforcement Learning](https://arxiv.org/abs/NeurIPS.2025)
...
- [Agentic RL Scaling Law: Spontaneous Code Execution for Mathematical Problem Solving](https://arxiv.org/abs/NeurIPS.2025)
...
- [Rethinking Verification for LLM Code Generation: From Generation to Testing](https://arxiv.org/abs/NeurIPS.2025)
...
- [ProRL: Prolonged Reinforcement Learning Expands Reasoning Boundaries in Large Language Models](https://arxiv.org/abs/NeurIPS.2025)
...
- [Scaling Code-Assisted Chain-of-Thoughts and Instructions for Model Reasoning](https://arxiv.org/abs/NeurIPS.2025)
...
- [The Surprising Effectiveness of Negative Reinforcement in LLM Reasoning](https://arxiv.org/abs/NeurIPS.2025)
...
- [Solver-Informed RL: Grounding Large Language Models for Authentic Optimization Modeling](https://arxiv.org/abs/NeurIPS.2025)
...
- [ATLAS: Autoformalizing Theorems through Lifting, Augmentation, and Synthesis of Data](https://arxiv.org/abs/NeurIPS.2025)
...
- [QiMeng-CodeV-R1: Reasoning-Enhanced Verilog Generation](https://arxiv.org/abs/NeurIPS.2025)
...
- [QiMeng-SALV: Signal-Aware Learning for Verilog Code Generation](https://arxiv.org/abs/NeurIPS.2025)
...
- [miniF2F-Lean Revisited: Reviewing Limitations and Charting a Path Forward](https://arxiv.org/abs/NeurIPS.2025)
...
- [SWE-SQL: Illuminating LLM Pathways to Solve User SQL Issues in Real-World Applications](https://arxiv.org/abs/NeurIPS.2025)
